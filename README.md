# Anve Music Bot Gizlilik Politikası

Anve'yi kullanarak aşağıdaki gizlilik politikasını kabul etmiş olursunuz.
...
Destek sunucusundan(https://discord.gg/asamimusic) Anve botun geliştricisi olan ancientxrd veya ancientxrd. ile iletişime geçerek direkt kişisel verilerinizi kaldırabilirsiniz. Sunucu verilerini ise botu sunucudan atarak kaldırabilirsiniz.

Fakat kara liste verilerini ancak geliştirici kaldırmayı uygun görürse kaldırır.

Not: Kullanıcılarımıza haber vermeksizin bunu değiştirme hakkını saklı tutarız. Bu politika en son 26 nisan 2024 tarihinde güncellenmiştir.
